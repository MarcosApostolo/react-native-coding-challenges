// A small curated list of common 5-letter words. Used both as the pool of
// possible answers and as the dictionary of accepted guesses.
export const WORD_LIST: string[] = [
  ...
  'drank', 'dream', 'dress', 'drill', 'drink', 'drive', 'drove', 'dying',
  'eager', 'early', 'earth', 'eight', 'elite', 'empty', 'enemy', 'enjoy',
  'enter', 'entry', 'equal', 'error', 'event', 'every', 'exact', 'exist',
  'extra', 'faith', 'fault', 'field', 'fifth', 'fifty', 'fight', 'final',
  ...
  'mouth', 'moved', 'movie', 'music', 'needs', 'never', 'newly', 'night',
  ...
  'robot', 'roman', 'rough', 'round', 'route', 'royal', 'rural', 'scale',
